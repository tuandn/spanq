...
<div id="banner">
    ...
    <div id="banner-right" style="float: right; width: 50%; height: 100%;">
        <div id="user"
             style="float: right; height: 25%; margin-top: 15px; margin-right: 15px; padding:0 10px 0 10px; background-color: red;">
            <p style="">Xin chao, <span style="text-decoration: underline;">mrcong</span> !</p>
        </div>
        <div class="clear"></div>
        <div id="info">

...
<head>
    ...
    <script language="JavaScript" type="text/javascript"
            src="http://localhost/spanq/application/themes/admin/js/jquery/jquery-1.10.1.min.js"></script>
    <script language="JavaScript" type="text/javascript"
            src="http://localhost/spanq/application/themes/admin/js/jquery/common.js"></script>
</head>
<body>
<div id="container">
    <div id="top">

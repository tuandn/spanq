...
<div id="main-right">
    ...
    <div id="nav-email">
        ...
        <div id="nav-frame-email">
            <table border="1" style="margin: auto; height: auto; width: 90%; margin-top: 25px;">
                <tr style="height: 30px;">
                    <th colspan="2" style="font-weight: bold; font-size: 12pt;" align="left">Gmail</th>
                </tr>
                <tr style="height: 35px;">
                    <td>Email Gmail</td>
                    <td><input type="text" id="txtEmail" name="txtEmail" style="width: 160px; height: 22px;"/></td>
                </tr>
                <tr style="height: 35px;">

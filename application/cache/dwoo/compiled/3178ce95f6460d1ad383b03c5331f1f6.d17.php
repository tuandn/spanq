...
<head>
    ...
    <script language="javascript" src="http://localhost/spanq/application/themes/default/css/jquery.treeview.css"></script>
    <script language="javascript" src="http://localhost/spanq/application/themes/default/js/jquery.min.js"></script>
    <script language="javascript" src="http://localhost/spanq/application/themes/default/js/jquery-ui.min.js"></script>
    <script language="JavaScript" type="text/javascript"
            src="http://localhost/spanq/application/themes/default/js/common.js"></script>
    <script language="JavaScript" type="text/javascript"
            src="http://localhost/spanq/application/themes/default/js/config.js"></script>
</head>
<body>
<div id="container">
    <div id="top">

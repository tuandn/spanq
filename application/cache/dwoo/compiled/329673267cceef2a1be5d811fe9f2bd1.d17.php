    ...
    <script type="text/javascript" language="javascript">
        $(document).ready(function () {
            ...
            function updateQuestion() {
                $.ajax({
                    url: BASE_URL + "question/updateQuestion/2",
                    type: 'POST',
                    dataType: 'html',
                    error: function () {
                    ...
                    success: function (output_string) {
                        //alert(output_string);
                        alert(parseInt(output_string) + 10);
            ...
            $("#dialog-form").dialog({
                ...
                buttons: {
                    "Thêm mới": function () {
                        ...
                        updateQuestion();
                        if (bValid) {
                            //$( "#questions tbody" ).append("<tr style='height: 40px;'><td><input id='question4' type='text' disabled='disabled' style='width: 285px;' value='" + question.val() + "'> <a href='javascript:editQuestion(4);'>Sửa</a></td></tr>");
                            //$( this ).dialog( "close" );
                        }
                    },
                    "Hủy bỏ": function () {

...
<head>
    ...
    <script language="JavaScript" type="text/javascript"
            src="http://localhost/socialnetwork/application/themes/default/js/check.info.js"></script>
        ...
        $(document).ready(function () {
            ...
            function checkLength(o, n, min, max) {
                if (o.val().length > max || o.val().length < min) {
                    ...
                    //updateTips( "Độ dài của câu hỏi " + n + " phải trong khoảng " +
                    //	min + " đến " + max + " ký tự." );
            ...
            $("#dialog-form").dialog({
                ...
                buttons: {
                    "Thêm mới": function () {
                        ...
                        bValid = bValid && checkLength(question, "question", 3, 16);

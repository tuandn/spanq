...
<div id="main-right">
    <div style="position: absolute; margin-top:50px; margin-left:50px; height: 200px; width: 300px;">
        <img alt="avartar" height="113" width="144" style="border: solid 1px #cbdbea;"

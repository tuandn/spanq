...
<script type="text/javascript" language="javascript">
    $(document).ready(function () {
        ...
        $('input#question_on').change(function () {
            if ($(this).is(':checked')) {
                //if(updateQuestionState(1)){
                var msg = updateQuestionState(1);
    ...
    function updateQuestionState(state) {
        $.ajax({
            url: BASE_URL + "user/home/updateQuestionState/" + state,
            type: 'POST',
            dataType: 'html',
            error: function () {
                alert("Chức năng đang cập nhật!");

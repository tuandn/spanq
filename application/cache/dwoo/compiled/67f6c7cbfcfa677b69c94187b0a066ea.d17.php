            ...
            $("#dialog-form").dialog({
                ...
                buttons: {
                    "Thêm mới": function () {
                        ...
                        if (bValid) {
                            $("#questions tbody").append("<tr style='height: 40px;'><td><input id='question4' type='text' disabled='disabled' style='width: 285px;' value='" + question.val() + "'> <a id='link_question_edit' href='javascript:editQuestion(4);'>Sửa</a></td></tr>");
                            $(this).dialog("close");
                        }
                    },
                    "Hủy bỏ": function () {

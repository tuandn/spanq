...
<head>
    ...
    <link rel="stylesheet" href="http://localhost/spanq/application/themes/bootstrap/css/demo_table.css"/>
    <link rel="stylesheet" href="http://localhost/spanq/application/themes/bootstrap/css/jquery.dataTables.css"/>
    ...
    <script language="javascript" type="text/javascript"
            src="http://localhost/spanq/application/themes/bootstrap/js/jquery.dataTables.js"></script>
    <!--<script language="javascript" type="text/javascript"
...
<div id="user-nav" class="navbar navbar-inverse">
    <ul class="nav btn-group">
        <li class="btn btn-inverse"><a href="#" title=""><i class="icon icon-user"></i> <span
                class="text">Adminnistrator</span></a></li>
...
<div id="sidebar">
    ...
    <ul>
        ...
        <li class="submenu" id="area">
            ...
            <ul>
                <li id="list_area"><a href="http://localhost/spanq/area">List area</a></li>
        ...
        <li class="submenu" id="group">
            ...
            <ul>
                <li id="list_group"><a href="http://localhost/spanq/group">List group</a></li>
        ...
        <li class="submenu" id="user">
            ...
            <ul>
                <li id="list_user"><a href="http://localhost/spanq/user">List user</a></li>
        ...
        <li class="submenu" id="landmark">
            ...
            <ul>
                <li id="list_landmark"><a href="http://localhost/spanq/landmark">List landmark</a></li>
        ...
        <li class="submenu" id="challenge">
            ...
            <ul>
                <li id="list_challenge"><a href="http://localhost/spanq/challenge">List challenge</a></li>
        ...
        <li class="submenu" id="response">
            ...
            <ul>
                <li id="list_response"><a href="http://localhost/spanq/response">List response</a></li>
                <li id="add_response"><a href="http://localhost/spanq/response/addresponse">New response</a></li>
            </ul>
        </li>
        <li class="submenu" id="station">
            <a href="javascript:"><i class="icon icon-th-list"></i> <span>Stations</span></a>
            <ul>
                <li id="list_station"><a href="http://localhost/spanq/station">List station</a></li>

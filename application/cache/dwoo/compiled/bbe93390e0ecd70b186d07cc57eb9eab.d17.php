...
<div id="banner">
    ...
    <div id="banner-right" style="float: right; width: 50%; height: 100%;">
        <div id="user" style="float: right; height: 25%; margin-top: 15px; margin-right: 15px; padding:0 10px 0 10px;">
            <p style="">Xin chao, <a href="#">mrcong</a> !</p>
        </div>
        <div class="clear"></div>
        <div id="info" style="background-image: url('../img/info_bg.png'); height: 50%; width: 200px;">

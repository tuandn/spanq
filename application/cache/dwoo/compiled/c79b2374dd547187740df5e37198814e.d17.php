...
<div id="sidebar">
    ...
    <ul>
        <li class="active"><a href="http://localhost/spanq/activity"><i class="icon icon-home"></i> <span>Spanq</span></a></li>
        <li class="submenu">
...
<!--<script src="http://localhost/spanq/application/themes/bootstrap/js/jquery-1.10.1.min.js"></script>-->

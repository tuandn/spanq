...
<head>
    ...
    <script language="javascript" type="text/javascript"
            src="http://localhost/spanq/application/themes/bootstrap/js/jquery.min.js" async></script>
    <script language="javascript" type="text/javascript"
            src="http://localhost/spanq/application/themes/bootstrap/js/jquery-ui.min.js"></script>
    <script language="javascript" type="text/javascript"

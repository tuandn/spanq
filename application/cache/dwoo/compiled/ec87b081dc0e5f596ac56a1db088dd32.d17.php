                ...
                $.ajax({
                    ...
                    success: function (output_string) {
                        if (parseInt(output_string) > 0) {
                            $("#questions tbody").append("<tr id='row" + output_string + "' style='height: 40px;'><td><input id='question4' type='text' disabled='disabled' style='width: 285px;' value='" + question.val() + "'> <a href='javascript:editQuestion(" + output_string + ");'>Sửa</a></td></tr>");

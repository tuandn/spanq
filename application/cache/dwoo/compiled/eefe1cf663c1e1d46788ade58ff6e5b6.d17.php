...
<head>
    ...
    <script type="text/javascript" language="javascript">
        $(document).ready(function () {
            ...
            var question = $("#dialog-form #txtquestion"),
            ...
            var question_update = $("#dialog-form-update #txtquestion"),
                allFields_update = $([]).add(question_update),
                tips_update = $("#dialog-form-update .validateTips");
            ...
            $("#dialog-form-update").dialog({
                ...
                buttons: {
                    "Cập nhật": function () {
                        var bValid = true;
                        allFields_update.removeClass("ui-state-error");
                        bValid = bValid && checkLength(question_update, "", 3, 300);
                        if (bValid) {
                            //createQuestion();
                        }
                    },
                ...
                close: function () {
                    allFields_update.val("").removeClass("ui-state-error");
                }
            });
        ...
        function editQuestion(id) {
            ...
            $("#dialog-form-update #txtquestion").text('ok');
        }

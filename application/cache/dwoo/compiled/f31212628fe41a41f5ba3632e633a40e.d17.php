...
<head>
    ...
    <script language="javascript" type="text/javascript"
            src="http://localhost/spanq/application/themes/bootstrap/js/jquery-ui.custom.min.js"></script>
    <script language="javascript" type="text/javascript"
    ...
    <script language="javascript" type="text/javascript"
            src="http://localhost/spanq/application/themes/bootstrap/js/unicorn.interface.js"></script>
    ...
    <ul>
        ...
        <li class="submenu">
            ...
            <ul>
                ...
                <li><a href="http://localhost/spanq/setting/add_murder">New murder mystery</a></li>

...
<head>
    ...
    <link rel="stylesheet" href="http://localhost/spanq/application/themes/bootstrap/css/bootstrap-responsive.min.css" />
    ...
    <link rel="stylesheet" href="http://localhost/spanq/application/themes/bootstrap/css/unicorn.grey.css" class="skin-color" />
</head>
<body>


<div id="header">
    <h1><a href="./dashboard.html">Spanq Admin</a></h1>
</div>
...
<div id="content">
    ...
    <div id="breadcrumb">
        ...
        <a href="#" class="current">Dashboard <?php echo $this->scope["template"]["body"];?></a>
    </div>
                        ...
                        <ul class="recent-posts">
                            <li>
                                <div class="user-thumb">
                                    <img width="40" height="40" alt="User" src="http://localhost/spanq/application/themes/bootstrap/img/demo/av2.jpg">
                                </div>
                            ...
                            <li>
                                <div class="user-thumb">
                                    <img width="40" height="40" alt="User" src="http://localhost/spanq/application/themes/bootstrap/img/demo/av3.jpg">
                                </div>
                                <div class="article-post">
                            ...
                            <li>
                                <div class="user-thumb">
                                    <img width="40" height="40" alt="User" src="http://localhost/spanq/application/themes/bootstrap/img/demo/av1.jpg">
                                </div>
                                <div class="article-post">

...
<div id="sidebar">
    ...
    <ul>
        <li class="active"><a href="http://localhost/spanq/activity"><i class="icon icon-home"></i> <span>Spanq</span></a>
        </li>
        <li class="submenu">
            <a href="/abc"><i class="icon icon-th-list"></i> <span>Areas</span> <span class="label">1</span></a>
            <ul>
...
<script language="javascript" type="text/javascript" src="http://localhost/spanq/application/themes/bootstrap/js/jquery.ui.custom.js"></script>
<script language="javascript" type="text/javascript" src="http://localhost/spanq/application/themes/bootstrap/js/bootstrap.min.js"></script>
<script language="javascript" type="text/javascript" src="http://localhost/spanq/application/themes/bootstrap/js/jquery.uniform.js"></script>
<script language="javascript" type="text/javascript" src="http://localhost/spanq/application/themes/bootstrap/js/jquery-1.10.1.min.js"></script>
</body>
</html>

...
<div id="main-right">
    ...
    <div id="nav-email">
        ...
        <div id="nav-frame-email">
            ...
            <div
                style="height: 34px; width: 98%; float: left; margin-left:5px; background-color: purple; margin-top: 15px; margin-bottom: 5px;">
                <a href="#">
                    <img alt="Logo" src="http://localhost/socialnetwork/application/themes/default/img/video1.jpg"/>
                </a>
            </div>
        </div>
        <div class="clear"></div>

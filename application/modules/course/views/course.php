            ...
            $.ajax({
                ...
                success: function (data_form) {
                    if (data_form > 1) {
                        ...
                        max_station = 0;
                        $("#cbArea-help-inline").removeClass("error-inline").addClass("error-inline").html(area + " not contain enough station to start a game.");
        ...
        <div class="span12">
            <div class="widget-box">
                ...
                <div class="widget-content nopadding">
                    <form class="form-horizontal" method="post" action="course/generate_random_station"
                        ...
                        <div class="control-group">
                            <label class="control-label">No of Stations<span class="required"> (*)</span></label>
                        ...
                        <div class="control-group">
                            <label class="control-label">No of Teams<span class="required"> (*)</span></label>
                        ...
                        <div class="control-group">
                            <label class="control-label">Phone hint<span class="required"> (*)</span></label>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <select name="cbPublish" id="cbPublish" style="width: 150px">
                                    <option value="0" <?php echo isset($list_game->IsPublished) && $list_game->IsPublished == "0" ? "selected" : ""; ?> >Private</option>
                                    <option value="1"  <?php echo isset($list_game->IsPublished) && $list_game->IsPublished == "1" ? "selected" : ""; ?> >Public</option>
                                </select>
                            </div>
                        </div>

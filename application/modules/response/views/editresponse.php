            ...
            <div class="span12">
                <div class="widget-box">
                    <div class="widget-title">
                        ...
                        <h5><?php echo $response->Answer; ?></h5>
                    </div>
                    <div class="widget-content nopadding">
                        <form class="form-horizontal" method="post" action="response/update" name="response_validate"
                            ...
                            <div class="form-actions">
                                ...
                                <input type="hidden" id="txtId" name="txtId" value="<?php echo $response->Id; ?>"/>
                            </div>
                        </form>
                    </div>
                </div>

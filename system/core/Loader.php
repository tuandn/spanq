...
class CI_Loader
{
     ...
     * Constructor
     *
     * Sets the path to the views files and gets the initial output buffering level
     */
     ...
     * Load View
     *
     * This function is used to load a "views" file.  It has three parameters:
     *
     * 1. The name of the "views" file to be included.
